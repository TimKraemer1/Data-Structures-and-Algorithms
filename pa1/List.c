...
//Creates new node object (reference used from queue example)
...
//Frees node object (freeNode function from queue example used as reference)
...
//returns True if two list are equal, false otherwise (equals function from queue example used as reference)
...
//creates new List and copies content from given List to new List
